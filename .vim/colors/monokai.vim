" ==== INCLUDES SMALL EDITS BY MARCEL GOH ====
"
...
let s:white       = { "gui": "#fefdea", "cterm": "253" }
let s:black       = { "gui": "#111111", "cterm": "235" }
...
let s:pink        = { "gui": "#FF5F87", "cterm": "204" }
...
call s:h("LineNr",        { "fg": s:orange,       "bg": s:black })
